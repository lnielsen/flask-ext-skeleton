...
htmlhelp_basename = 'Flask-YourExtdoc'
...
latex_documents = [
  ('index', 'Flask-YourExt.tex', u'Flask-YourExt Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    ('index', 'flask-yourext', u'Flask-YourExt Documentation',
     [u'CERN'], 1)
]
...
texinfo_documents = [
  ('index', 'Flask-YourExt', u'Flask-YourExt Documentation',
   u'CERN', 'Flask-YourExt', 'One line description of project.',
   'Miscellaneous'),
]
